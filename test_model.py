...
def load_improved_models():
    ...
    if os.path.exists('models/direction_classifier.pkl'):
        ...
        print("❌ Direction classifier not found. Run price_direction_random_forest_xgboost_model.py first.")
        return None
...
def main():
    ...
    if models is None:
        print("❌ Cannot proceed without models. Please run price_direction_random_forest_xgboost_model.py first.")
        return
